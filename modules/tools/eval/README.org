← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::tools eval][Issues]]  ↖ [[doom-source:modules/tools/eval/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :tools eval
