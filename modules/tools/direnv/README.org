← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::tools direnv][Issues]]  ↖ [[doom-source:modules/tools/direnv/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :tools direnv
