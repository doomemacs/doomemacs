← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::tools rgb][Issues]]  ↖ [[doom-source:modules/tools/rgb/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :tools rgb
