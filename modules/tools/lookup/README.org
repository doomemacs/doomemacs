← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::tools lookup][Issues]]  ↖ [[doom-source:modules/tools/lookup/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :tools lookup
