← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::tools pass][Issues]]  ↖ [[doom-source:modules/tools/pass/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :tools pass
