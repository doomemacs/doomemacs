← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::emacs vc][Issues]]  ↖ [[doom-source:modules/emacs/vc/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :emacs vc
