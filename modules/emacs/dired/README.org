← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::emacs dired][Issues]]  ↖ [[doom-source:modules/emacs/dired/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :emacs dired
