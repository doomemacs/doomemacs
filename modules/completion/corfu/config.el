...
(use-package! corfu
  ...
  ;; Return non-nil if another completion system is active in the current
  ;; completion context. This helps decide whether Corfu should handle
  ;; completion or defer to whichever framework is already active.
