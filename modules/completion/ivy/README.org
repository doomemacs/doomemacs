...
** Regular Expression
Regular expression can be used to perform more precise search. However,
usage of regular expression *disables fuzzy search capabilities*.

If you have =+fuzzy=, you can make use of this behaviour to perform non-fuzzy
search
