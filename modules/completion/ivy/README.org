...
When [[file:~/.emacs.d/modules/tools/lsp/README.org][LSP module]] is active, [[https://github.com/emacs-lsp/lsp-ivy][lsp-ivy]] is used to provide easy navigation to any
