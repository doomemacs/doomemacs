← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::os tty][Issues]]  ↖ [[doom-repo:tree/develop/modules/os/tty/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :os tty
