← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::checkers syntax][Issues]]  ↖ [[doom-source:modules/checkers/syntax/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
