...
| =SPC m r i a=      | search imports to add         |
| =SPC m b b=        | run =go build=                |
| =SPC m t f=        | run all tests in current file |
| =SPC m t a=        | run all tests in current file |
| =SPC m t s=        | run test under cursor         |
