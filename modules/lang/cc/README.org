← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::lang cc][Issues]]  ↖ [[doom-source:modules/lang/cc/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :lang cc
#+SUBTITLE: C > C++ == 1
