← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui window-select][Issues]]  ↖ [[doom-source:modules/ui/window-select/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
