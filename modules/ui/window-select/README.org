← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui window-select][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/window-select/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
