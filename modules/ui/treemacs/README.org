← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui treemacs][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/treemacs/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui treemacs
