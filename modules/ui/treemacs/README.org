← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui treemacs][Issues]]  ↖ [[doom-source:modules/ui/treemacs/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui treemacs
