← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui doom-dashboard][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/doom-dashboard/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
