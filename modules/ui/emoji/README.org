← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui emoji][Issues]]  ↖ [[doom-source:modules/ui/emoji/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui emoji
#+SUBTITLE: 💩
