← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui doom][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/doom/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui doom
