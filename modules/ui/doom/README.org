...
** Custom themes
To set a custom theme for Doom Emacs, you may either [[https://github.com/hlissner/doom-emacs/issues/117][load]] an external theme package or use the ~custom-theme-directory~ variable.
