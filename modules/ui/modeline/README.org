← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui modeline][Issues]]  ↖ [[doom-source:modules/ui/modeline/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui modeline
