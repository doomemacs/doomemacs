← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui modeline][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/modeline/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui modeline
