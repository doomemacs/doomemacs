← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui doom-quit][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/doom-quit/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui doom-quit
