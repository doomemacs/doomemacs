← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui workspaces][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/workspaces/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui workspaces
