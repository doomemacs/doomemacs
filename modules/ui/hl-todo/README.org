← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui hl-todo][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/hl-todo/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui hl-todo
