← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui deft][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/deft/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui deft
