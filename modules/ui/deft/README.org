← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui deft][Issues]]  ↖ [[doom-source:modules/ui/deft/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui deft
