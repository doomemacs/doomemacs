← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui ligatures][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/ligatures/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui ligatures
