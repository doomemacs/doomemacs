← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui nav-flash][Issues]]  ↖ [[doom-source:modules/ui/nav-flash/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui nav-flash
