← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui nav-flash][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/nav-flash/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+title:    :ui nav-flash
