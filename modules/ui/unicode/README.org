← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui unicode][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/unicode/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui unicode
