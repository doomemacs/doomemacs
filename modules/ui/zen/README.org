← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::ui zen][Issues]]  ↖ [[doom-repo:tree/develop/modules/ui/zen/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :ui zen
