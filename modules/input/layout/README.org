← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::input layout][Issues]]  ↖ [[doom-source:modules/input/layout/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :input layout
