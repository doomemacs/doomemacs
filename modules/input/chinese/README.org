← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::input chinese][Issues]]  ↖ [[doom-source:modules/input/chinese/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :input chinese
