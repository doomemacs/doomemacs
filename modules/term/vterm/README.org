← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::term vterm][Issues]]  ↖ [[doom-source:modules/term/vterm/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
#+TITLE:    :term vterm
