...
(evil-ex-define-cmd "tabc[lose]"  #'+workspaces/kill)
(evil-ex-define-cmd "tabclear"    #'doom/kill-all-buffers)
(evil-ex-define-cmd "tabl[ast]"   #'+workspaces/switch-to-last)
(evil-ex-define-cmd "tabload"     #'+workspaces:load)
(evil-ex-define-cmd "tabe[dit]"   #'+workspaces:edit)
(evil-ex-define-cmd "tabnew"      #'+workspaces:new)
(evil-ex-define-cmd "tabn[ext]"   #'+workspaces:switch-next)
(evil-ex-define-cmd "tabp[rev]"   #'+workspaces:switch-previous)
(evil-ex-define-cmd "tabr[ename]" #'+workspaces:rename)
(evil-ex-define-cmd "tabs"        #'+workspaces/switch-to)
(evil-ex-define-cmd "tabsave"     #'+workspaces:save)
