← [[doom-module-index:][Back to module index]]               ! [[doom-module-issues:::editor file-templates][Issues]]  ↖ [[doom-source:modules/editor/file-templates/][Github]]  ± [[doom-suggest-edit:][Suggest edits]]  ? [[doom-help-modules:][Help]]
--------------------------------------------------------------------------------
