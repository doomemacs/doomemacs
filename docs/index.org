...
- [[https://github.com/doomemacs/doomemacs/issues][Our issue tracker]]

** Project roadmap
- [[https://github.com/doomemacs/doomemacs/projects/3][Development roadmap]] - A timeline outlining what's being worked on and when it
  is expected to be done.
- [[https://github.com/doomemacs/doomemacs/projects/2][Plugins under review]] - A sitrep on third party plugins that we've considered,
  rejected, or awaiting integration into Doom.
- [[https://github.com/doomemacs/doomemacs/projects/5][Upstream bugs]] - Tracks issues originating from plugins and external programs
  that Doom relies on.
