...
- [[#common-issues][Common Issues]]
  ...
  - [[#theres-artifacting-on-my-icon-fonts-in-gui-emacs-956][There's artifacting on my icon fonts in GUI Emacs (#956)]]
...
** There's artifacting on my icon fonts in GUI Emacs ([[https://github.com/hlissner/doom-emacs/issues/956][#956]])
