...
Another alternative (which is [[https://github.com/doomemacs/doomemacs/blob/develop/core/core.el#L269-L274][what Doom uses]]) is the [[https://gitlab.com/koral/gcmh/][gcmh]] package; which staves
...
=straight= (which powers our package manager) does this for you too, but [[https://github.com/doomemacs/doomemacs/tree/develop/core/cli/autoloads.el][Doom
...
git clone https://github.com/doomemacs/doomemacs ~/fakehome/doom-emacs
...
** There's artefacting on my icon fonts in GUI Emacs ([[https://github.com/doomemacs/doomemacs/issues/956][#956]])
Check your font rendering settings. Changing the RGBA order to "rgba" will often
fix this issue. See [[https://github.com/doomemacs/doomemacs/issues/956][#956]] for details.

** The =s= and =S= keys don't behave like they do in vim/evil ([[https://github.com/doomemacs/doomemacs/issues/1307][#1307]])
...
+ On some systems (particularly MacOS), manipulating the fringes or window
  ...
  Or disable the =:ui doom-dashboard= & =:tools magit= modules (see [[https://github.com/doomemacs/doomemacs/issues/1170][#1170]]).
...
1. It is generally expected that third party themes will [[https://github.com/doomemacs/emacs-doom-themes/blob/master/doom-themes.el#L400-L405][add themselves]] to
...
Sometimes, if you've installed a [[https://github.com/doomemacs/doomemacs/issues/2213][broken package]] which was subsequently fixed
...
[[https://github.com/doomemacs/doomemacs/blob/develop/core/core-ui.el#L132-L150][Doom highlights non-standard indentation]]. i.e. Indentation that doesn't match
