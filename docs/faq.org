...
> **Doom's FAQs have [[https://discourse.doomemacs.org/faq][moved to Discourse]].**
...
1. [Enable](https://github.com/hlissner/doom-emacs/blob/develop/docs/faq.org#how-do-i-enable-or-disable-a-doom-module) the =:tools lsp= module,
