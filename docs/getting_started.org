...
=hlissner/doom-emacs= has been cloned to =~/.config/emacs=):
...
cp ~/.config/emacs/init.example.el ~/.doom.d/init.el
cp ~/.config/emacs/core/templates/config.example.el ~/.doom.d/config.el
cp ~/.config/emacs/core/templates/packages.example.el ~/.doom.d/packages.el
