...
**** Ubuntu
Since only Emacs 26.3 is available on Ubuntu 20.04 (and 25.3 on Ubuntu 18.04), extra steps are necessary to acquire 27.1:
#+BEGIN_SRC bash
...
To install Emacs 28 on Ubuntu, you'll need to build it from source.
