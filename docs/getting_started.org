...
[[https://github.com/doomemacs/doom-emacs/issues/4876][issue #4876]])
#+begin_src sh
...
#+BEGIN_SRC bash
git clone https://github.com/doomemacs/doom-emacs ~/.emacs.d
...
=doomemacs/doom-emacs= has been cloned to =~/.emacs.d=):
...
1. First, install Doom somewhere:
   ...
   git clone https://github.com/doomemacs/doom-emacs ~/doom-emacs
...
+ Look up errors/warnings [[file:faq.org::Common Issues][on the FAQ]] and [[https://github.com/doomemacs/doom-emacs/issues][Doom's issue tracker]]. It is possible
