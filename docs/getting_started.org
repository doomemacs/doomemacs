...
The remainder of this section will go over the technical details of a Doom module.
...
+ Perform expensive or error-prone operations; these files are evaluated
