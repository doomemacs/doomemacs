...
cp ~/.emacs.d/templates/init.example.el ~/.doom.d/init.el
cp ~/.emacs.d/templates/config.example.el ~/.doom.d/config.el
cp ~/.emacs.d/templates/packages.example.el ~/.doom.d/packages.el
