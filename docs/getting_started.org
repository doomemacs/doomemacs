...
#+BEGIN_SRC bash
# required dependencies
xbps-install git ripgrep emacs-gtk3 emacs-common # the regular emacs package installs emacs for terminal use. you have to install emacs-gtk3 for the.you can still use emacs in the terminal with emacs -nw.
# optional dependencies
xbps-install fd
#+END_SRC
