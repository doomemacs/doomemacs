...
(deftheme narf-write "A light theme for writing, inspired by Ulysses")
...
(let* ((c '((class color)))
  ...
  (custom-theme-set-faces
   ...
   `(hs-face                         ((,c (:foreground ,black :background ,current-line))))
   ...
   `(italic                         ((,c (:slant italic :foreground "#AAAAAA"))))
   ...
   ;; neotree
   `(neo-root-dir-face           ((,c (:foreground ,blue))))
   `(neo-file-link-face          ((,c (:foreground ,black))))
   `(neo-dir-link-face           ((,c (:foreground ,red :bold t))))
   `(neo-expand-btn-face         ((,c (:foreground ,red :bold t))))

   ;; company-mode
   ;; `(company-tooltip             ((,c (:background ,white :foreground ,fg))))
   ...
   `(helm-ff-dotted-directory ((,c (:foreground ,grey-2))))
   `(helm-ff-directory ((,c (:foreground ,orange :bold t))))
   `(helm-ff-executable ((,c (:foreground ,grey-2 :slant italic))))
   ...
   `(org-meta-line              ((,c (:foreground ,grey-1))))
   ...
   `(org-level-6          ((,c (:foreground "#444444" :bold t))))
   ;;`(org-level-7          ((,c ())))
   ;;`(org-level-8          ((,c ())))
   ...
   `(org-list-dt          ((,c (:foreground ,black :bold t))))
